...
router.post('/assesorValuesService', function (req, res) {
	...
	models.AssesorValues.create({
		...
		var success = {}
		success.message = "Successfully inserted record: " + data.get('wFNo')

		winston.log("info","Successfully inserted record to db: " + data.get('wFNo'))
...
router.post('/imageService', function (req, res) {
	...
	models.Images.create({
		...
		var success = {}
		success.message = "Successfully inserted image: " + data.get('imageName')

		winston.log("info","Successfully inserted record to db: " + data.get('imageName'))
...
//res.render('home/index', {app : intimationNo})
